...
import { LayoutDashboard, Webhook, FileText, Settings, Users, LogOut, Menu, X, List, Mail, User } from 'lucide-react';
...
const Layout = ({ children, user, logout }) => {
  ...
  if (user.role === 'admin') {
    navigation.splice(6, 0, { name: 'Users', href: '/users', icon: Users });
  }
